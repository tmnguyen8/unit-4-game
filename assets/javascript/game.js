...
// available crystal images in an array
...
// FUNCTION / EXECUTION
// **************************************************************************
// Execute function newGame()
newGame();

// Function newGame() is started/repeated at the end of the game
function newGame() {
    // var targetNumLow = 19; //inclusive of 19
    // var targetNumHigh = 120+1; //inclusive of 120 (plus 1 to consider the round down of function Math.floor)
    var targetNum =  Math.floor(Math.random() * (targetNumHigh - targetNumLow)) + targetNumLow;
    ...
    // empty any images defined in previous game
    $(".myCrystals").empty();

    // Create images with data attribute
